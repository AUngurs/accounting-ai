...
export const partnerRules = (partners, partner) => {
  ...
  if (!maxLength(partner.name, 100))
    errors.name = "Nosaukums nedrīkst būt garāks par 100 simboliem";

  if (
    partner.reg_nr &&
    !uniqueInArray(partners, "partner_reg_nr", partner.reg_nr, partner.id)
  )
